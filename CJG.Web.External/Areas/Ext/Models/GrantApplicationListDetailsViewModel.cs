	...
	public class GrantApplicationListDetailsViewModel
	{
		...
		void SetStatusInfo(ApplicationStateExternal status)
		{
			switch (status)
			{
				...
				case ApplicationStateExternal.Complete: this.StatusCssClass = "complete"; this.StatusText = "COMPLETE"; break;
				case ApplicationStateExternal.Submitted: this.StatusCssClass = "complete"; this.StatusText = "Submitted"; break;
