...
namespace CJG.Web.External.Areas.Ext.Controllers
{
	...
	public class UserProfileController : BaseController
	{
		...
		public JsonResult UpdateUserProfile(UserProfileViewModel viewModel)
		{
			try
			{
				viewModel.UserProfileDetails.Provinces = _staticDataService.GetProvinces()
					.OrderBy(x => x.Name)
				...
				if (ModelState.IsValid)
				{
					...
					UpdateUserAddressesOnApplications(_userService, _siteMinderService, _applicationAddressService);
				}
				else
				{
		...
		private void UpdateUserAddressesOnApplications(IUserService userService, ISiteMinderService siteMinderService, IApplicationAddressService applicationAddressService)
		{
			if (userService == null)
				throw
			...
			applicationAddressService.UpdateUserAddressesOnApplications(currentUser, organization);
		}
