	...
	public class ChangeRequestController : BaseController
	{
		...
		public JsonResult ChangeDeliveryDates(DeliveryDateViewModel model)
		{
			...
			try
			{
				...
				if (!grantApplication.ViableTrainingDateUpdate(start))
					throw new InvalidOperationException("Training start date can only be changed prior to your claim being submitted.");
