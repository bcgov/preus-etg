...
namespace CJG.Web.External.Areas.Ext.Controllers
{
	...
	public class ClaimController : BaseController
	{
		...
		[ValidateRequestHeader]
		[Route("Claim/Cost")]
		public JsonResult UpdateClaimEligibleCosts(List<ClaimEligibleCostModel> claimEligibleCosts)
		{
			var model = new ClaimReportViewModel();
			try
			{
				var claimEligibleCost = _claimEligibleCostService.Get(claimEligibleCosts.FirstOrDefault().Id);
				_claimEligibleCostService.Update(claimEligibleCosts);
