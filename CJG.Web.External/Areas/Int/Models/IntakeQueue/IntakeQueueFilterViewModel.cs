...
namespace CJG.Web.External.Areas.Int.Models.IntakeQueue
{
	public class IntakeQueueFilterViewModel : BaseViewModel
	{
		...
		public ApplicationFilter GetFilter()
		{
			...
			return new ApplicationFilter(states, AssessorId, FiscalYearId, TrainingPeriodCaption, GrantProgramId, GrantStreamId, orderBy: OrderBy, onlyShowPriorityRegionExceptions: PriorityExceptionsMode.OnlyShowNonExceptions);
		}
	}
}