...
namespace CJG.Web.External.Areas.Int.Controllers
{
	...
	public class ReconciliationController : BaseController
	{
		...
		public JsonResult ReconcileReport(HttpPostedFileBase file, bool createNew = false)
		{
			...
			try
			{
				var fileStream = file.Validate(maxUploadSize, permittedAttachmentTypes).InputStream;
				var report = _paymentReconciliationService.Reconcile(fileStream, createNew);
