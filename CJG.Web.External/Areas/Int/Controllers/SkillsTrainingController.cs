	...
	public class SkillsTrainingController : BaseController
	{
		...
		public JsonResult GetTrainingProgram(int trainingProgramId)
		{
			...
			try
			{
				...
				model = new Models.SkillsTraining.SkillsTrainingProgramViewModel(trainingProgram, User, _cipsCodesService);
			}
			catch (Exception ex)
			{
		...
		public JsonResult AddComponent(HttpPostedFileBase[] files, string component)
		{
			...
			try
			{
				...
				if (ModelState.IsValid)
				{
					...
					viewModel = new Models.SkillsTraining.SkillsTrainingProgramViewModel(trainingProgram, User, _cipsCodesService);
				}
				else
				{
