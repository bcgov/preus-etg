	...
	public class ProgramDescriptionViewModelValidation
	{
		...
		public static ValidationResult ValidateNOC(int? NOCLevelId, ValidationContext context)
		{
			if (context.ObjectInstance is Areas.Ext.Models.ProgramDescriptions.ProgramDescriptionViewModel extModel)
			{
				...
				{
					case "Noc1Id":
						if (NOCLevelId == null) return new ValidationResult("NOC is required to four levels.");
						break;
					case "Noc2Id":
						if (NOCLevelId == null && extModel.Noc1Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
					case "Noc3Id":
						if (NOCLevelId == null && extModel.Noc2Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
					case "Noc4Id":
						if (NOCLevelId == null && extModel.Noc3Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
				}
			}
			else if (context.ObjectInstance is Areas.Int.Models.ProgramDescriptions.ProgramDescriptionViewModel intModel)
			{
				switch (context.MemberName)
				{
					case "Noc1Id":
						...
						break;
					case "Noc2Id":
						if (NOCLevelId == null && intModel.Noc1Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
					case "Noc3Id":
						if (NOCLevelId == null && intModel.Noc2Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
					case "Noc4Id":
						if (NOCLevelId == null && intModel.Noc3Id != null) return new ValidationResult("NOC is required to four levels.");
						break;
				}
			}
			return ValidationResult.Success;
