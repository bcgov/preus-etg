...
app.controller('TrainingCostsView', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  ...
  $scope.recalculate = function () {
    ...
    if ($scope.EligibleCost.EligibleExpenseType) {
      ...
      $scope.EligibleCost.EstimatedReimbursement = calculateReimbursement($scope.EligibleCost.EstimatedCost);
  ...
  function calculateReimbursement(cost) {
  ...
  function calculateTotals() {
    ...
    $scope.model.TotalEmployer = employerTotal;
    $scope.model.TotalRequest = reimbursementTotal;
    calculateESSTotal();
  }
