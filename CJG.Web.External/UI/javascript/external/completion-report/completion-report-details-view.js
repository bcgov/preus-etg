app.controller('CompletionReportDetailsView', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  $scope.section = {
    name: 'CompletionReportDetailsView',
    onRefresh: function () {
  ...
  function loadCompletionReport() {
    return $scope.load({
      url: '/Ext/Reporting/Completion/Report/Details/Data/' + $attrs.grantApplicationId,
      set: 'model'
    });
  }
