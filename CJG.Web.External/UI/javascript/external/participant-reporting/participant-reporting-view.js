app.controller('ParticipantReportingView', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  ...
  $scope.removeParticipant = function (participant) {
    return $scope.confirmDialog('Remove Participant', '<p>Remove ' + participant.FirstName + ' ' + participant.LastName + ' from this application?</p>  <p>Removing a participant deletes their information and excludes them from receiving funding as part of this grant as well as removing them from any claims you are currently reporting.</p>')
      .then(function () {
        return $scope.load({
