app.controller('GrantProgramHomePageMessage', function ($scope, $attrs, $controller, $timeout, Utils) {
  $scope.section = {
    name: 'GrantProgramHomePageMessage',
    save: {
      url: '/Int/Admin/Grant/Program/Home/Page/Message',
      method: 'PUT',
      data: function () {
        return $scope.model;
      },
