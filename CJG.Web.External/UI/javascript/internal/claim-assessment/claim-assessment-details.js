...
app.controller('ClaimAssessmentDetails', function ($scope, $attrs, $controller, $timeout, Utils, ngDialog) {
  ...
  **/
  ...
  $scope.recalculateParticipantCost = function (participantCost, claimEligibleCost) {
    ...
    var claimParticipantCost = participantCost.AssessedParticipantCost == null ? 0 : participantCost.AssessedParticipantCost;
  ...
  function validateClaimEligibleCost(claimEligibleCost) {
    ...
    if (claimEligibleCost.AgreedMaxCost < claimEligibleCost.AssessedCost) {
      add('AssessedCost', 'Training cost cannot be greater than the agreed max cost.');
    }

    // AssessedReimbursementCost
    if (claimEligibleCost.AgreedMaxReimbursement < claimEligibleCost.AssessedReimbursementCost) {
    ...
    if (claimEligibleCost.ExpenseType === utils.ExpenseTypes.ParticipantAssigned || claimEligibleCost.ExpenseType === utils.ExpenseTypes.ParticipantLimited) {
      ...
      if (claimEligibleCost.AgreedMaxParticipantReimbursement < claimEligibleCost.AssessedMaxParticipantReimbursementCost) {
      ...
      if (claimEligibleCost.AgreedMaxParticipantCost < claimEligibleCost.AssessedMaxParticipantCost) {
