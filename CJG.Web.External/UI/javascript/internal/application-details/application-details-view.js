  ...
  function confirmAction() {
    if ($scope.parent.editing) {
      return new Promise(function (resolve, reject) {
        $scope.confirmCancel('Unsaved Changes', 'Finish editing before attempting to perform a worflow action. Clicking "Cancel" will undo any edits you have currently made.')
          .then(function () {
            reject();
          })
          .catch(function () {
  ...
  function getReason(url, trigger) {
    ...
    switch (trigger) {
      ...
      case ('CancelAgreementMinistry'):
        ...
        text = 'You agreement has been cancelled for the following reason:';
        break;
