      ...
      if (!notificationType.ValidationErrors) {
        return $timeout(function () {
          if (notificationType.IsDeleted) {
            ...
            $scope.alert.message = 'Notification type succesfully deleted.';
          } else {
            ...
            if (found) {
              ...
              $scope.alert.message = 'Notification type succesfully updated.';
            } else {
              $scope.model.Items.push(notificationType);
              $scope.pager.items.total++;
              $scope.pager.items.last++;

              $scope.alert.message = 'Notification type succesfully added.';
            }
          }
        });
      }
