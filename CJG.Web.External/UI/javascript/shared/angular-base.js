...
app.controller('Base', function ($scope, $sce, $timeout, Utils, ngDialog) {
  ...
  */
   ...
   * @returns {Promise}
   */
  $scope.attachmentDialog = function (title, attachment, showAttachmentType = false, customAttachmentTypes = '') {
    if (!title)
      title = 'Attachment';
    ...
    let allowedAttachmentTypes = ".pdf,.doc,.docx,.xlsx,.xls,.jpg,.png,.gif,.jpeg";
    if (customAttachmentTypes !== '')
      allowedAttachmentTypes = customAttachmentTypes;
