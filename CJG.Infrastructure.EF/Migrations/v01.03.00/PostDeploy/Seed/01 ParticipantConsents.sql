...
<p>
	The Government of Canada ("Canada") provides funding for the Canada-B.C. Job Grant ("CJG") under the Canada-British Columbia Job Fund Agreement ("CJF"), administered by the British Columbia Ministry of Jobs, Tourism and Skills Training ("JTST"), and under the Labour Market Development Agreement ("LMDA"), administered by the British Columbia Ministry of Social Development and Social Innovation ("SDSI"). 
</p>
<p>
