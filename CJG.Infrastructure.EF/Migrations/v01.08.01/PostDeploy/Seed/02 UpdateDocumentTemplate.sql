...
<hr>
<p>
    If you have any questions about the collection, use or disclosure of your Personal Information, please contact the Program Manager, Canada-BC Job Grant at 1-877-952-6914, or by mail at: Program Manager, @Model.GrantOpening.GrantStream.GrantProgram.Name, 2nd Floor, 1106 Cook Street, Victoria, BC, V8V 3Z9 or by submitting an email to <a href="mailto:@(program.ProgramCode)Info@gov.bc.ca">@(program.ProgramCode)Info@gov.bc.ca</a>
</p>
'
WHERE ID = 5;

-- Update all DocumentTemplates
PRINT 'UPDATE ALL DocumentTemplates'
UPDATE [dbo].[DocumentTemplates]
SET [Body] = REPLACE( REPLACE( [Body], 'B.C. Employer Training Grant', '@Model.GrantOpening.GrantStream.GrantProgram.Name'), 'ETG', '@(Model.GrantOpening.GrantStream.GrantProgram.ProgramCode)')
