PRINT 'Inserting [DocumentTemplates]'
SET IDENTITY_INSERT [dbo].[DocumentTemplates] ON 
INSERT [dbo].[DocumentTemplates]
 ([Id], [IsActive], [DocumentType], [Title], [Body]) VALUES
 (1, 1, 1,
  N'Initial Grant Agreement Template Title',
  N'
...
<br />
<br />
<p>I am authorized to act and to enter into this Agreement on behalf of the Employer and, on the Employer''s behalf, I do hereby accept and agree to the terms and conditions of this Agreement, including this Approval Letter and the attached Schedules A (Approved Training) and B (Definitions and General Terms)</p>
