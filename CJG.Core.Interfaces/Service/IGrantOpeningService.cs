...
namespace CJG.Core.Interfaces.Service
{
	...
	public interface IGrantOpeningService : IService
	{
		...
		IDictionary<int, decimal> GetBudgetllocationAmountsInTrainingPeriods(int fiscalYearId, int? programId, int? grantStreamId);
		Dictionary<int, decimal[]> GetGrantOpeningFinancialsInTrainingPeriods(int fiscalYearId, int? programId, int? grantStreamId);
