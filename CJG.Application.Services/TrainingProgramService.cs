...
namespace CJG.Application.Services
{
	...
	public class TrainingProgramService : Service, ITrainingProgramService
	{
		...
		public TrainingProgramService(ITrainingProviderService trainingProviderService,
		...
		{
			if (!trainingProgram.EligibleCostBreakdownId.HasValue) throw new InvalidOperationException("Cannot change the eligibilty of this program.");
			...
			if (claim?.ClaimState.In(ClaimState.Incomplete, ClaimState.Complete) ?? false)
			{
				...
				{
					// Add the eligibile cost breakdown to the claim.
