	...
	public class GrantAgreementService : Service, IGrantAgreementService
	{
		...
		public DocumentTemplate GetDocumentTemplate(DocumentTypes documentType)
		{
			return _dbContext.DocumentTemplates
				.OrderByDescending(dt => dt.DateAdded)
				.FirstOrDefault(dt => dt.IsActive && dt.DocumentType == documentType);
		}
		...
		public void UpdateAgreement(GrantApplication grantApplication)
		{
			...
			var firstTrainingProgram = grantApplication.TrainingPrograms
			...
			if (grantApplication.ApplicationStateInternal.In(ApplicationStateInternal.AgreementAccepted, ApplicationStateInternal.ChangeRequest, ApplicationStateInternal.NewClaim, ApplicationStateInternal.ChangeForApproval, ApplicationStateInternal.ChangeForDenial, ApplicationStateInternal.ChangeReturned, ApplicationStateInternal.ChangeRequestDenied))
			{
