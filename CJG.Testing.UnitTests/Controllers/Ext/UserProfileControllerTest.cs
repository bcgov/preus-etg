...
namespace CJG.Testing.UnitTests.Controllers.Ext
{
	...
	public class UserProfileControllerTest
	{
		...
		public void GetUserProfile()
		{
			...
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			var userGrantProgramPreferenceModel = new UserGrantProgramPreferenceModel()
			{
				ProgramId = 1,
				Name = "Test Name",
			...
			helper.GetMock<IUserService>().Setup(m => m.GetPreferencePrograms(It.IsAny<int>()))
				.Returns(new List<UserGrantProgramPreferenceModel>() { userGrantProgramPreferenceModel });
		...
		public void CreateUserProfile()
		{
			...
			var preferenceProgram = new UserGrantProgramPreferenceModel()
			{
				IsSelected = true
			};
			...
			{
				UserId = user.Id,
				RowVewsion = "AgQGCAoMDhASFA==",
				PreferencePrograms = new List<UserGrantProgramPreferenceModel>() { preferenceProgram },
			...
			helper.GetMock<IUserService>()
				.Verify(m => m.CreateUserProfile(It.IsAny<Guid>(), It.IsAny<UserProfileDetailModel>(), It.IsAny<List<UserGrantProgramPreferenceModel>>()), Times.Once);
		}
		...
		public void CreateUserProfile_Invalid()
		{
			...
			helper.GetMock<IStaticDataService>().Verify(m => m.GetProvinces(), Times.Once);
			helper.GetMock<IUserService>()
				.Verify(m => m.CreateUserProfile(It.IsAny<Guid>(), It.IsAny<UserProfileDetailModel>(), It.IsAny<List<UserGrantProgramPreferenceModel>>()), Times.Never);
		}
		...
		public void UpdateUserProfile()
		{
			...
			helper.GetMock<IStaticDataService>().Verify(m => m.GetProvinces(), Times.Once);
			helper.GetMock<IUserService>()
				.Verify(m => m.UpdateUserProfile(It.IsAny<int>(), It.IsAny<UserProfileDetailModel>(), It.IsAny<List<UserGrantProgramPreferenceModel>>()), Times.Once);
		}
		...
		public void UpdateUserProfile_Invalid()
		{
			...
			helper.GetMock<IStaticDataService>().Verify(m => m.GetProvinces(), Times.Once);
			helper.GetMock<IUserService>()
				.Verify(m => m.UpdateUserProfile(It.IsAny<int>(), It.IsAny<UserProfileDetailModel>(), It.IsAny<List<UserGrantProgramPreferenceModel>>()), Times.Never);
		}
		...
		#region GrantProgramPreferencesView
		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void GrantProgramPreferencesView()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			...
			// Act
			var result = controller.GrantProgramPreferencesView();
		...
		#region GetGrantProgramPreferences
		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void GetGrantProgramPreferences()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			...
			// Act
			var result = controller.GetGrantProgramPreferences();

			// Assert
			result.Should().NotBeNull().And.BeOfType<JsonResult>();
			result.Data.Should().NotBeNull().And.BeOfType<UserProfileViewModel>();
			var model = result.Data as UserProfileViewModel;
			model.PreferencePrograms[0].ProgramId.Should().Be(userGrantProgramPreferenceModel.ProgramId);
			model.PreferencePrograms[0].Name.Should().Be(userGrantProgramPreferenceModel.Name);
			model.PreferencePrograms[0].Description.Should().Be(userGrantProgramPreferenceModel.Description);
			model.UserId.Should().Be(user.Id);
		}

		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void GetGrantProgramPreferences_NoImplement()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			...
			result.Data.Should().NotBeNull().And.BeOfType<UserProfileViewModel>();
			var model = result.Data as UserProfileViewModel;
			model.PreferencePrograms.Count().Should().Be(0);
			model.UserId.Should().Be(user.Id);
		}

		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void GetGrantProgramPreferences_NotAuthorizedException()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			...
			helper.GetMock<IUserService>().Verify(m => m.GetPreferencePrograms(It.IsAny<int>()), Times.Never);
		}
		#endregion

		#region UpdateGrantProgramPreferences
		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void UpdateGrantProgramPreferences()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			...
			var userProfileViewModel = new UserProfileViewModel()
			{
				UserId = user.Id,
				RowVewsion = "AgQGCAoMDhASFA==",
				PreferencePrograms = new List<UserGrantProgramPreferenceModel>() { }
			};
			// Act
			var result = controller.UpdateGrantProgramPreferences(userProfileViewModel);

			// Assert
			result.Should().NotBeNull().And.BeOfType<JsonResult>();
			result.Data.Should().NotBeNull().And.BeOfType<UserProfileViewModel>();
			var model = result.Data as UserProfileViewModel;
			model.ReturnURL.Should().Be("/Ext/Home/Index");
			helper.GetMock<IUserService>()
				.Verify(m => m.UpdateGrantProgramPreferences(
					It.IsAny<int>(), It.IsAny<List<UserGrantProgramPreferenceModel>>(), It.IsAny<bool>()
					), Times.Once);
		}

		[TestMethod, TestCategory("Controller"), TestCategory(nameof(UserProfileController))]
		public void UpdateGrantProgramPreferences_NotAuthorizedException()
		{
			// Arrange
			var user = EntityHelper.CreateExternalUser();
			var helper = new ControllerHelper<UserProfileController>(user);
			helper.GetMock<IUserService>()
				.Setup(m => m.UpdateGrantProgramPreferences(
					It.IsAny<int>(), It.IsAny<List<UserGrantProgramPreferenceModel>>(), It.IsAny<bool>()))
			...
			result.Data.Should().NotBeNull().And.BeOfType<UserProfileViewModel>();
			controller.HttpContext.Response.StatusCode.Should().Be(403);
			helper.GetMock<IUserService>().Verify(m => m.UpdateGrantProgramPreferences(It.IsAny<int>(), It.IsAny<List<UserGrantProgramPreferenceModel>>(), It.IsAny<bool>()), Times.Once);
		}
		#endregion
	}
}
