	...
	public class TrainingProgram : EntityBase
	{
		...
		public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			if (!this.DeliveryMethods.Any())
				yield return new ValidationResult("You must select at least one delivery method.", new[] { nameof(this.DeliveryMethods) });
			...
			if (this.HasRequestedAdditionalFunding && String.IsNullOrEmpty(this.DescriptionOfFundingRequested))
				yield return new ValidationResult("If you have requested additional funding you must include a description of the funding request.", new[] { nameof(this.DescriptionOfFundingRequested) });
