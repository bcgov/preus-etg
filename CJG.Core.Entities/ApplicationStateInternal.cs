...
namespace CJG.Core.Entities
{
	...
	/// Often a change to the Internal state is NOT reflected in a similar change to the External state until an inforamtion exchange
	...
	public enum ApplicationStateInternal
	{
		...
		/// <summary>
		/// RecommenedForDenial - The assessor has recommended to the director that the grant application be denied.
		/// The external state is "Submitted"
		/// </summary>
		[Description("Recommended for Denial")]
		RecommendedForDenial = 6,
		/// <summary>
		/// OfferIssued - As the first step in approval for a grant, the Director has issued an offer in the form of an Agreement for acceptance by the application administrtor.
		...
		OfferIssued = 7,
		/// <summary>
		/// OfferWithdrawn - The Agreement has been withdrawn by the Minitry before Application Administrator acceptance. This occurs at the discretion of 
		...
		Closed = 30,
		/// <summary>
		/// ClaimAssessReimbursement - An Assessor has selected a claim for reimbursement assessmennt and is assigned to the grant file as the assessor.
		/// The external state is "Claim Submitted"
		/// </summary>
