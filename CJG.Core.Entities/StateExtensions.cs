...
namespace CJG.Core.Entities
{
	...
	public static class StateExtensions
	{
		...
		private static readonly IDictionary<ApplicationStateInternal, IEnumerable<ApplicationWorkflowTrigger>> ValidWorkflowTriggers = new Dictionary<ApplicationStateInternal, IEnumerable<ApplicationWorkflowTrigger>>()
		{
			...
			{ ApplicationStateInternal.ApplicationWithdrawn, new[] {        ApplicationWorkflowTrigger.ViewApplication, ApplicationWorkflowTrigger.EditApplication, ApplicationWorkflowTrigger.AddRemoveTrainingProvider,   ApplicationWorkflowTrigger.EditTrainingProvider,                                                        ApplicationWorkflowTrigger.EditTrainingProgram, ApplicationWorkflowTrigger.EditTrainingCosts, ApplicationWorkflowTrigger.EditTrainingCostOverride, ApplicationWorkflowTrigger.EditSummary,  ApplicationWorkflowTrigger.EditApplicationAttachments,                                                                                               ApplicationWorkflowTrigger.EditApplicantContact,                                                                                                                                                                                                                                                                                                            ApplicationWorkflowTrigger.ViewParticipants } },
			{ ApplicationStateInternal.CancelledByMinistry, new[] {         ApplicationWorkflowTrigger.ViewApplication, ApplicationWorkflowTrigger.EditApplication,                                                                                                                                                                                                                                                                                                                    ApplicationWorkflowTrigger.EditSummary,                                                          ApplicationWorkflowTrigger.EditApplicant, ApplicationWorkflowTrigger.EditProgramDescription, ApplicationWorkflowTrigger.EditApplicantContact,                                                                                                        ApplicationWorkflowTrigger.ReassignAssessor,                                                                                                                                                        ApplicationWorkflowTrigger.ViewParticipants,                                                                                                                                                            ApplicationWorkflowTrigger.ViewClaim } },
			{ ApplicationStateInternal.CancelledByAgreementHolder, new[] {  ApplicationWorkflowTrigger.ViewApplication, ApplicationWorkflowTrigger.EditApplication,                                                                                                                                                                                                                                                                                                                    ApplicationWorkflowTrigger.EditSummary,                                                          ApplicationWorkflowTrigger.EditApplicant, ApplicationWorkflowTrigger.EditProgramDescription, ApplicationWorkflowTrigger.EditApplicantContact,                                                                                                        ApplicationWorkflowTrigger.ReassignAssessor,                                                                                                                                                        ApplicationWorkflowTrigger.ViewParticipants } },
		...
		private static readonly IDictionary<ApplicationStateInternal, IEnumerable<ApplicationStateInternal>> InternalStateTransitions = new Dictionary<ApplicationStateInternal, IEnumerable<ApplicationStateInternal>>()
		{
			...
			{ ApplicationStateInternal.New, new[] { ApplicationStateInternal.PendingAssessment, ApplicationStateInternal.Unfunded, ApplicationStateInternal.ApplicationWithdrawn } },
			...
			{ ApplicationStateInternal.UnderAssessment, new[] { ApplicationStateInternal.RecommendedForApproval, ApplicationStateInternal.RecommendedForDenial, ApplicationStateInternal.ApplicationWithdrawn } },
			...
			{ ApplicationStateInternal.OfferIssued, new[] { ApplicationStateInternal.OfferWithdrawn, ApplicationStateInternal.AgreementAccepted, ApplicationStateInternal.AgreementRejected } },
			{ ApplicationStateInternal.OfferWithdrawn, new ApplicationStateInternal[0] },
			...
			{ ApplicationStateInternal.CancelledByMinistry, new ApplicationStateInternal[0] },
		...
		private static readonly IDictionary<ApplicationStateExternal, IEnumerable<ApplicationStateExternal>> ExternalStateTransitions = new Dictionary<ApplicationStateExternal, IEnumerable<ApplicationStateExternal>>()
		{
			...
			{ ApplicationStateExternal.Submitted, new[] { ApplicationStateExternal.ApplicationWithdrawn, ApplicationStateExternal.ApplicationDenied, ApplicationStateExternal.AcceptGrantAgreement, ApplicationStateExternal.NotAccepted } },
			...
			{ ApplicationStateExternal.AcceptGrantAgreement, new[] { ApplicationStateExternal.AgreementWithdrawn, ApplicationStateExternal.Approved, ApplicationStateExternal.AgreementRejected } },
			{ ApplicationStateExternal.AgreementWithdrawn, new ApplicationStateExternal[0] },
			...
			{ ApplicationStateExternal.CancelledByMinistry, new ApplicationStateExternal[0] },
