...
{
	/// <summary>
	/// <typeparamref name="TypeExtensions"/> static class, provides extension methods for <typeparamref name="Type"/>.
	/// </summary>
	public static class TypeExtensions
	{
		...
		/// </summary>
		public const double FloatTollerance = 0.00001;
		...
		public static IEnumerable<PropertyInfo> GetCachedProperties(this Type type)
		{
			...
			if (!_typeCache.TryGetValue(type, out props))
			{
		...
		/// <summary>
		/// Get the actual entity type from the proxy.
		/// </summary>
		/// <param name="type"></param>
		/// <returns></returns>
