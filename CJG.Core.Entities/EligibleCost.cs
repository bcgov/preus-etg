...
namespace CJG.Core.Entities
{
	...
	public class EligibleCost : EntityBase
	{
		...
		public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			if (this.EligibleExpenseType.ExpenseTypeId.In(ExpenseTypes.ParticipantLimited, ExpenseTypes.ParticipantAssigned)
				...
				yield return new ValidationResult($"The total requested government contribution exceeds the per participant fiscal year maximum reimbursement allowed of '{maxReimbursementAmount.ToString("c2")}' for expense type '{this.EligibleExpenseType.Caption}'", new[] { nameof(this.EstimatedReimbursement) });
