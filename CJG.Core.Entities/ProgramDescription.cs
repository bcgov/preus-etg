	...
	public class ProgramDescription : EntityBase
	{
		...
		public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			if (this.DescriptionState == ProgramDescriptionStates.Complete)
			{
				...
				{
					// Participant employment status required.
					if (this.ParticipantEmploymentStatusId == null)
						yield return new ValidationResult($"Participant Employment Status must be selected.", new[] { nameof(this.ParticipantEmploymentStatusId) });
